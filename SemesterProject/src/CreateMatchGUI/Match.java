...
public class Match implements Serializable
{
   ...
   public void setPLayers(Player player)
   {
      if (!mplayers.contains(player))
      {
         ...
         {
            if (mplayers.getNumOfPlayers() < CUP)
            {
               mplayers.addPlayer(player);
            }
         }
         ...
         {
            if (mplayers.getNumOfPlayers() < LEAGUE)
            {
               mplayers.addPlayer(player);
            }
         }
   ...
   /**
    * gets number of players available for cup match
   ...
   /**
    * gets number of players available for league match
    * @return number of players
    */
   public int numLeague()
   {
      return LEAGUE;
   }
