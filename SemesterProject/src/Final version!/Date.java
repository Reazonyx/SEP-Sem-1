...
public class Date implements Serializable
{
   ...
   /**
    * 5-argument constructor that sets year, month, day, hour and minute to the
    * class Date.
    * 
    * @param year
    *           what the Date's year will be set to.
    * @param month
    *           what the Date's month will be set to.
    * @param day
    *           what the Date's day will be set to.
    * @param hour
    *           what the Date's hour will be set to.
    * @param minute
    *           what the Date's minute will be set to.
    */
    ...
    * 
    * @return a String representation of the Date in the format: "Year: year,
   ...
   /**
    * gets a current day with help of GregorianCalendar which is inbuild class in Java
    * @return current date
    */
   ...
   /**
    * checks if the object date it before current date
    * @return true if date it before current date and false if the date is after current date
    */
   public boolean isBefore()
   {
      if (year < Date.today().year)
         ...
         return true;
            ...
            && day == Date.today().day && hour < Date.today().hour)
      {
         return true;
      }
      else if (year == Date.today().year && month == Date.today().month
            && day == Date.today().day && hour == Date.today().hour
            && minute < Date.today().minute)
      {
         return true;
      }
      else
