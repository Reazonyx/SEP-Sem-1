...
/**
 * A simple program used for importing data. It reads a text file with player
 * informations, creates a PlayerList object with all player read from the
 * file, and saves it as a binary file. The text file must have information of
 * one player on each line, and each line should be in the format:
 * name, number, position and note
 * 
 * @author group 10
 * @version 1.0
 */
public class LoadInitialDataPlayer
{
